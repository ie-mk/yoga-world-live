...
import Styled from './ReplyMobileModelMessage.styles';
        ...
        {({ values, handleSubmit }) => (
          <form onSubmit={handleSubmit}>
            ...
            <Styled.InputRowWrapper>
              <AdminUploadImage width="25%" label="Attachements" />
            </Styled.InputRowWrapper>
            <Styled.InputRow>
              <AdminInput
                name="subject"
...
export default connect(mapStateToProps)(ReplyMobileModelMessage);
